                ...
                foreach ($assets as $asset) { 
                    ...
                    <tr>
                        ...
                        <?php if ($asset->updated_at == NULL) { ?>
                            <td style="text-align: center;"><button onclick="sellAssets(this)" data-toggle="modal" id="btnPointsModal" data-target="#sellAsset" class="btn btn-primary sell__points" data-asset-id="<?php echo e($asset->id); ?>" data-assets-id="<?php echo e($asset->assets_id); ?>" data-asset-name="<?php echo e($asset->name); ?>" data-asset-current-price="<?php echo e($asset->current_value); ?>" data-asset-quantity="<?php echo e($asset->quantity); ?>" data-asset-current-quantity="<?php echo e($asset->quantity); ?>"> Sell</button>
                            </td>
                        <?php } else {
                        ?>
