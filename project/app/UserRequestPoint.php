...
class UserRequestPoint extends Authenticatable implements EnumUserRole, EnumUserStatus, MustVerifyEmail
{
    use Notifiable {
     ...
     */
    protected $fillable = [
        'name', 'email', 'role', 'status', 'password', 'last_login_time', 'last_login_ip',
    ];
